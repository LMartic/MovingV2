...
{
    public partial class JobReviewMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobReviews_Job",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobReviews_User",
                        column: x => x.UserId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 13, new DateTime(2020, 8, 21, 14, 31, 7, 401, DateTimeKind.Local).AddTicks(6685), null, "Create New Job Review", false, false, null, "Create New Job Review" });
